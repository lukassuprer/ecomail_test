...
/**
 * Card component to display data from API
 * @param card - Card object containing the card details
 * 
 * @returns Card component to display card details
 */

const CardComponent = ({ card }: CardProps) => {
    return (
        <div className="flex flex-col w-[360px] h-fit bg-primary-card rounded-[15px]">
            <div
